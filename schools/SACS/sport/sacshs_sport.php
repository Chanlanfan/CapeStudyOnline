...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.7.0/jquery.min.js"></script>
  ...
  <script type=”text/javascript” src=”loadSport.js” ></script>
...
<div id="sport-menu">
  <div id='water-polo'>
<form method="get" onclick='javascript:function makeWpolo(){
    let sport = "wpolo"
    doRefresh();
}'>
  <button>
...
<!-- rugby -->
<div id='rugby'>
<form method="get" onclick='javascript:function makeRugby(){
    let sport = "rugby"
    doRefresh();
}'>
  <button >
