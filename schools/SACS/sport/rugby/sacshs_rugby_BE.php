...
<?php 
$sql = "SELECT * FROM sport_rugby WHERE priority = '1'   ORDER BY id DESC LIMIT 1 ";
$result = $conn->query($sql);
...
<div id="score-card"> <!--  -->
<? $sql2 = "SELECT * FROM sport_rugby  ORDER BY CASE WHEN game_status = 'live' THEN 1 ELSE 2 END, id DESC ";
